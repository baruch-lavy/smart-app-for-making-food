/**
 * Writes the correct seeds/recipes.js with all 21 exact recipes.
 * Called automatically by create-all-server-files.js, or run standalone:
 *   node fix-seeds.js
 */
const fs = require("fs");
...
const content = `require('dotenv').config({ path: require('path').join(__dirname, '../.env') });
...
const recipes = [
  {
    ...
    steps: [
      ...
      { order: 3, instruction: 'Spread tomato sauce evenly, leaving a 1-inch border.', tip: 'Don\'t over-sauce — less is more for authentic pizza.', whyItMatters: 'Too much sauce makes the center soggy and overwhelms the other flavors.' },
      { order: 4, instruction: 'Tear mozzarella into pieces and scatter over the sauce.', tip: 'Pat the mozzarella dry with paper towels first if it\'s very wet.', whyItMatters: 'Wet cheese releases water during baking, making the pizza soggy.' },
      ...
      { order: 6, instruction: 'Remove from oven, top with fresh basil leaves and a drizzle of olive oil.', tip: 'Add basil after baking to preserve its bright color and fresh aroma.', whyItMatters: 'Heat destroys basil\'s volatile oils quickly, making it dull and bitter.' }
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { order: 2, instruction: 'Heat oil in a wok over high heat. Cook chicken until golden, about 4 minutes. Set aside.', tip: 'Don\'t overcrowd the wok — cook in batches if needed.', whyItMatters: 'High heat and space creates the "wok hei" smoky flavor that makes fried rice special.' },
  ...
  },
  {
    ...
    steps: [
      { order: 1, instruction: 'Halve and pit the avocados. Scoop flesh into a bowl.', tip: 'Use a spoon to scoop close to the dark green flesh near the skin — that\'s where nutrients are concentrated.', whyItMatters: 'The outermost flesh has the most antioxidants and gives guacamole its vibrant green color.' },
      { order: 2, instruction: 'Add lime juice and mash to your desired texture.', tip: 'Add lime juice immediately after cutting to prevent browning.', whyItMatters: 'Lime juice\'s acidity slows the oxidation that turns avocado brown.' },
  ...
  },
  {
    ...
    steps: [
      ...
      { order: 3, instruction: 'Combine all vegetables and olives in a large bowl.', tip: 'Use the best quality olive oil you can afford — it\'s the dressing.', whyItMatters: 'In simple dishes, ingredient quality shines through since there\'s nothing to hide behind.' },
      { order: 4, instruction: 'Place a block of feta on top, drizzle with olive oil, sprinkle oregano, and serve.', tip: 'Don\'t crumble the feta — serve it as a block for a more authentic presentation.', whyItMatters: 'A block of feta looks dramatic and lets diners break off their preferred amount.' }
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { order: 3, instruction: 'Heat grill or pan to high heat. Cook patties 3-4 minutes per side.', tip: 'Do not press the patty while cooking — you\'ll squeeze out the precious juices.', whyItMatters: 'Burgers are juicy because fat melts into the meat; pressing forces that moisture out.' },
  ...
  },
  {
    ...
    steps: [
      { order: 1, instruction: 'Marinate chicken in yogurt, garam masala, turmeric, and salt for at least 1 hour.', tip: 'Overnight marination gives deeper flavor penetration.', whyItMatters: 'Yogurt\'s lactic acid tenderizes the protein fibers, making the chicken incredibly moist.' },
  ...
  },
  {
    ...
    steps: [
      { order: 1, instruction: 'Bring a large pot of salted water to a boil. Cook spaghetti until al dente.', tip: 'Reserve 1 cup of pasta water before draining — it\'s liquid gold.', whyItMatters: 'Starchy pasta water is the emulsifier that turns eggs and cheese into a silky sauce.' },
  ...
  {
    title: 'Pad Thai',
    description: 'Thailand\'s beloved stir-fried rice noodles with shrimp, eggs, and peanuts.',
    cuisine: 'Asian',
    difficulty: 'medium',
    cookingTime: 20,
    prepTime: 15,
    ...
    steps: [
      { order: 1, instruction: 'Soak rice noodles in room temperature water for 30 minutes until pliable.', tip: 'Don\'t use hot water — noodles should be barely softened to finish cooking in the wok.', whyItMatters: 'Over-soaked noodles will turn mushy in the wok. They should still have a slight firmness.' },
  ...
  },
  {
    ...
    steps: [
      ...
      { order: 3, instruction: 'Sauté garlic and ginger in butter. Add remaining spices and toast 1 minute.', tip: 'The kitchen should smell incredible at this step — if it doesn\'t, your spices may be old.', whyItMatters: 'Fresh spices are at their most potent; old spices can give dull, flat flavor.' },
  ...
  },
  {
    ...
    steps: [
      ...
      { order: 4, instruction: 'Remove pork, slice thin. Season broth with soy sauce and miso.', tip: 'Never boil miso broth — add miso after removing from heat for best flavor.', whyItMatters: 'Boiling destroys miso\'s fermented probiotics and creates a bitter, flat taste.' },
  ...
  },
  {
    ...
    steps: [
      ...
      { order: 4, instruction: 'Drizzle with olive oil and balsamic glaze. Season with salt and pepper just before serving.', tip: 'Use the best quality olive oil you have — it\'s showcased here, not hidden.', whyItMatters: 'In simple dishes, each ingredient is prominent; inferior olive oil will noticeably diminish the dish.' }
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { order: 2, instruction: 'Mash anchovies and garlic into a paste with the flat of a knife.', tip: 'Don\'t skip the anchovies — they provide savory depth without tasting "fishy".', whyItMatters: 'Anchovies dissolve into the dressing and provide glutamates that make everything taste more savory.' },
      { order: 3, instruction: 'Whisk together anchovy paste, egg yolk, mustard, and lemon juice.', tip: 'Room temperature egg yolk emulsifies better than a cold one.', whyItMatters: 'The yolk\'s lecithin acts as an emulsifier, binding the oil and water-based ingredients into a creamy dressing.' },
  ...
  },
  {
    ...
    steps: [
      ...
      { order: 2, instruction: 'Pour wet ingredients into dry. Mix until JUST combined — lumps are okay.', tip: 'Overmixing develops gluten which makes pancakes tough and flat.', whyItMatters: 'Lumps mean you haven\'t over-developed the gluten — they disappear during cooking and result in fluffiness.' },
  ...
  },
  {
    ...
    steps: [
      ...
      { order: 2, instruction: 'Sauté vegetables in a large pot until softened, about 5 minutes.', tip: 'Don\'t rush this step — properly sweated vegetables release their sweetest flavors.', whyItMatters: 'Sautéed vegetables give up their volatile compounds to the fat, building the first layer of soup flavor.' },
...
fs.writeFileSync(path.join(seedsDir, "recipes.js"), content, "utf8");
console.log("✅ Wrote correct seeds/recipes.js (21 recipes)");
