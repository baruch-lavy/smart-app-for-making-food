...
const householdMemberSchema = new mongoose.Schema({
  ...
  relationship: {
    type: String,
    enum: ["self", "spouse", "partner", "child", "parent", "roommate", "other"],
    default: "other",
  },
  age: Number,
...
const achievementSchema = new mongoose.Schema({
  ...
  category: {
    type: String,
    enum: ["cooking", "learning", "consistency", "exploration", "mastery"],
  },
});
...
const userSchema = new mongoose.Schema(
  {
    ...
    childrenMode: { type: Boolean, default: false },
