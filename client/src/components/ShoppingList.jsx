  ...
  return (
    <div className="min-h-screen bg-gradient-mesh pt-14">
      ...
      <div className="max-w-2xl mx-auto px-4 pt-5">
        <form
          onSubmit={handleAdd}
          className="card p-4 mb-5 flex gap-2 flex-wrap"
        >
          <input
            value={form.name}
            ...
            required
            className="flex-1 min-w-[140px] input-field"
          />
          <input
            value={form.quantity}
            onChange={(e) =>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12 text-gray-500">
            ...
            <p className="text-sm mt-1">
              Add items manually or get suggestions from a recipe!
            </p>
          </div>
        ) : (
              ...
              <div key={groupKey}>
                ...
                <div className="flex items-center gap-2 mb-2 px-1">
                  ...
                  <span className="text-xs text-gray-400">
                    {grouped[groupKey].filter((i) => i.checked).length}/
                ...
                <div className="space-y-2">
                  {grouped[groupKey].map((item) => (
                    ...
                    >
                      <div
                        className={`w-5 h-5 rounded border-2 flex items-center justify-center flex-shrink-0 ${item.checked ? "bg-primary border-primary" : "border-gray-300"}`}
                      >
                        {item.checked && (
                          <svg
                      ...
                      <div className="flex-1">
                        <span
                          className={`font-medium text-sm ${item.checked ? "line-through text-gray-400" : "text-gray-900"}`}
                        >
                          {item.name}
                        </span>
